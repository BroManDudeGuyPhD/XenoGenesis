...
function updateInviteVisibility() {
    ...
    // Also update module health pill visibility (mod/admin only)
    if (typeof updateModuleHealthPillVisibility === 'function') {
        updateModuleHealthPillVisibility();
    }
}
...
// [Extracted to modules/modals.js]

// [Extracted to modules/neon-alerts.js]

// [Extracted to modules/invite-modals.js]

// [Extracted to modules/experiment-end-modal.js]
...
// [Extracted to modules/lightning-modals.js]
    ...
    */
    ...
    if (globalNameText) {
        globalNameText.onclick = function(){
            ...
            // Only hide game when NOT in an active game session
            // During a running game, clicking "Global" should just switch
            // the chat panel to show global messages, not close the game
            if (!gameActive && gameDiv) {
                gameDiv.style.display = 'none';
            }
        }
    }
    ...
    if (inviteButton) {
        ...
        inviteButton.addEventListener('click', (e) => {
            ...
            // Guard: only admins can use invite functionality
            if (!isGlobalAdmin) {
                console.warn('⚠️ Invite card clicked by non-admin user — ignoring');
                return;
            }
...
// [Extracted to modules/notifications.js (showSystemNotification)]
...
// [Extracted to modules/debug-utils.js]

// [Extracted to modules/invite-system.js]

// [Extracted to modules/confirmation-modals.js]
...
// [Extracted to modules/switchboard.js]

// [Extracted to modules/notifications.js (getNotificationArea)]

// [Extracted to modules/incentive-banner.js]

// [Extracted to modules/token-animations.js]

// [Extracted to modules/results-panel.js]
...
function updateEvaluateVisibility() {
    ...
    if (evaluateCard) {
        if (shouldShowEvaluate) {
            ...
            evaluateCard.style.pointerEvents = 'auto';
        } else {
            ...
            evaluateCard.style.pointerEvents = 'none';
        }
    }
}
